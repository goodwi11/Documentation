...
3. **Всегда используйте** доменное имя при генерации вайтов. Прописанное доменное имя повысит уникальность самого вайта и повысит качество всей связки, что положительно повляиет на прохождение модерации.
